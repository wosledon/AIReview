        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Temperature = table.Column<double>(type: "REAL", nullable: false, defaultValue: 0.29999999999999999),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    IsDefault = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    ExtraParameters = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseBranch = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false, defaultValue: "main"),
                    Status = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 0),
                    PullRequestNumber = table.Column<int>(type: "INTEGER", nullable: true),
                    AIOverallScore = table.Column<double>(type: "REAL", nullable: true),
                    AISummary = table.Column<string>(type: "TEXT", nullable: true),
                    AIReviewedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_review_requests_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_review_requests_projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_review_comments_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_review_comments_review_requests_ReviewRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LLMConfigurations_IsDefault",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_review_comments_AuthorId",
                table: "review_comments",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_review_comments_ReviewRequestId",
                table: "review_comments",
                column: "ReviewRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_review_requests_AuthorId",
                table: "review_requests",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_review_requests_ProjectId",
                table: "review_requests",
                column: "ProjectId");
        }
